public class Main {
    public static void main(String[] args) {
        ...
        int numberOfDays = 7;
        int slowWeightLossGram = 250;
        int quickWeightLossGram = 500;
        double denominatorKg = 1000f;
        int slowWeightLossKg = (int) (numberOfDays/(slowWeightLossGram/denominatorKg));
        System.out.println("Количество дней при медленном похудении составит " + slowWeightLossKg+ " дней,");
        int quickWeightLossKg = (int) (numberOfDays/(quickWeightLossGram/denominatorKg));
